...
@login_required(login_url='doctorlogin')
@user_passes_test(is_doctor)    
def get_all_patientDetails_for_doctor(request):
    ...
    try:
        ...
        return render(request, 'hospital/patient_details_doctor.html', {'patient_details': processed_patient_details})

    except requests.RequestException as e:
        print(f"Error fetching patient details: {e}")
        return render(request, 'hospital/patient_details_doctor.html', {'error': str(e)})
...
def get_all_patientDetails_for_patient(request):
    ...
    try:
        ...
        # Pass the processed patient details to the template
        return render(request, 'hospital/all_patient_details.html', {'patient_details': processed_patient_details})  

    except requests.RequestException as e:
        print(f"Error fetching patient details: {e}")
        return render(request, 'hospital/all_patient_details.html', {'error': str(e)})   
...
def get_all_prescriptions_for_patient(request):   
    ...
    try:
        ...
        # Pass the processed prescriptions to the template
        return render(request, 'hospital/patient_prescriptions.html', {'prescriptions': processed_prescriptions})  

    except requests.RequestException as e:
        print(f"Error fetching prescriptions: {e}")
        return render(request, 'hospital/patient_prescriptions.html', {'error': str(e)})  
